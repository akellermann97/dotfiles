...
;; rcic stuff
(setq rcirc-default-nick "Dormio")
(setq rcirc-default-full-name "Alexander K")
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (use-package weechat counsel org-ref evil-leader ivy zenburn-theme which-key sublimity solarized-theme smex racer projectile powerline nord-theme markdown-mode magit linum-relative ido-vertical-mode gruvbox-theme flycheck exec-path-from-shell evil dashboard company-jedi company-anaconda auto-complete auctex)))
